...
The latest package release at the time this README was updated is `v0.1.0-10`,
which contains both OpenWrt 24 `.ipk` and OpenWrt 25 `.apk` artifacts.

For example, `localClash` core `v0.1.13` can be adopted by the existing
`localclash-luci v0.1.0-10` package because the package bootstrap flow reads the
